...
const UUID = process.env.UUID || '66aac57b-6297-4358-a40e-c2d1b5feec68'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'onmyway';            // 获取节点的订阅路径
const NAME = process.env.NAME || '';                       // 节点名称
const PORT = process.env.PORT || 3300;                     // http和ws服务端口
